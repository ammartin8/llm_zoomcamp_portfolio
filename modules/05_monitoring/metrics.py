...
from rag_helper import RAGBase, LMStudioRAG # chat completions api
...
class RAGWithMetrics(LMStudioRAG):
    ...
    def llm(self, prompt):
        ...
        return response.choices[0].message.content # changed to chat completions api response output
