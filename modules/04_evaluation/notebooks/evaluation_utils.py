...
def llm_structured(client, instructions, user_prompt, output_type, model="qwen3.5-9b_coding_fast"):
    messages = [
...
def llm_structured_chat_completions(client, instructions, user_prompt, output_type, model="qwen3.5-9b_coding_fast"):
    messages = [
        {"role": "developer", "content": instructions},
        {"role": "user", "content": user_prompt}
    ]
